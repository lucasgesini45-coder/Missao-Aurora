 # MISSÃO AURORA SINGER -  Descrição do projeto
   ...
   A MISSÃO AURORA SINGER é um projeto em PYTHON que simula o projeto de checagem e autorização, que regula o lançamento de um foguete. O sistema executa uma série de 
